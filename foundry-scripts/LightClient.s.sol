...
//    bytes public constant init_cs_bytes = hex"";
    ...
    function transferToRelayer() public {
        ...
        address developer = vm.addr(privateKey);
        console.log("developer", developer, developer.balance);
        console.log("-------------------------------------------------start transfer to relayer");
    ...
    function syncTendermintHeader() public {
        console.log("relayer0", relayer0, relayer0.balance);
        console.log("-------------------------------------------------start syncTendermintHeader");
        ...
        vm.startBroadcast();
        GnfdLightClient(_lightClient).syncTendermintHeader(_header, _height);
        vm.stopBroadcast();
    }
